...
function Gallery() {
  ...
  this.addVisual = function(vis) {
    ...
    menuItem.mouseClicked(function(e)
    {
        ...
        //Make background white when moving away from the BP votes tab.
        let voteBPid = select('#BP-Votes');
        if(voteBPid.elt.classList.length == 1){
