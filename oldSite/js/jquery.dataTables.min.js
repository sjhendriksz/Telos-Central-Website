...
n.defaults={
	...
	fnStateLoadCallback:function(a){
		try{return JSON.parse((-1===a.iStateDuration?sessionStorage:localStorage).getItem("DataTables_"+ a.sInstance+"_"+location.pathname))}
		catch(b){}
	},
	...
	oFeatures:{
		...
		fnDisplayEnd:function(){
			...
			n.ext=x={
				...
				var Lb=n.ext.pager;h.extend(Lb,{
					simple:function(){
				...
				h.extend(!0,n.ext.renderer,{
					pageButton:{_:function(a,b,c,d,e,f){
						...
						i=a.oLanguage.oAria.paginate||{},m,l,n=0,o=function(b,d){
			...
			"string-asc":function(a,b){return a<b?-1:a>b?1:0},"string-desc":function(a,b){return a<b?1:a>b?-1:0}
				...
				Da("");h.extend(!0,n.ext.renderer,{
					header:{_:function(a,b,c,d){h(a.nTable).on("order.dt.DT",function(e,f,g,h){if(a===f){e=c.idx;b.removeClass(c.sSortingClass+" "+d.sSortAsc+" "+d.sSortDesc).addClass(h[e]=="asc"?d.sSortAsc:h[e]=="desc"?d.sSortDesc:
